...
class StorageService {
  ...
  static initDefaultData() {
    ...
    const materials = [
      { id: generateUUID(), name: '身份证原件', type: 'required', itemId: item1Id, description: '申请人身份证', tolerateDays: 0 },
      { id: generateUUID(), name: '申请表', type: 'required', itemId: item1Id, description: '工商登记申请表', tolerateDays: 0 },
      { id: generateUUID(), name: '经营场所证明', type: 'tolerable', itemId: item1Id, description: '房产证或租赁合同', tolerateDays: 3 },
      { id: generateUUID(), name: '章程', type: 'tolerable', itemId: item1Id, description: '公司章程', tolerateDays: 5 },
      
      { id: generateUUID(), name: '身份证', type: 'required', itemId: item2Id, description: '参保人身份证', tolerateDays: 0 },
      { id: generateUUID(), name: '劳动合同', type: 'required', itemId: item2Id, description: '用人单位劳动合同', tolerateDays: 0 },
      { id: generateUUID(), name: '营业执照复印件', type: 'tolerable', itemId: item2Id, description: '单位营业执照', tolerateDays: 2 },
      
      { id: generateUUID(), name: '申请人身份证明', type: 'required', itemId: item3Id, description: '身份证等有效证件', tolerateDays: 0 },
      { id: generateUUID(), name: '不动产权属来源证明', type: 'required', itemId: item3Id, description: '购房合同、土地证明等', tolerateDays: 0 },
      { id: generateUUID(), name: '完税证明', type: 'tolerable', itemId: item3Id, description: '相关税费缴纳证明', tolerateDays: 7 }
    ];
